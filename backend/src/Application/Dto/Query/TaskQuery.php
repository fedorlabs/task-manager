...
class TaskQuery
{
    ...
    #[Assert\Choice(choices: ['id', 'title', 'createdAt', 'updatedAt', 'dueDate', 'sortOrder'])]
    ...
    public static function fromRequest(Request $request, QueryParamResolver $resolver): self
    {
        ...
        $dto->columnId = $resolver->getOptionalPositiveInt($request, 'columnId');
        $dto->statusId = $resolver->getOptionalPositiveInt($request, 'statusId');
